...
- **Every φ number measured before 2026-09-06 was measured through the 2L packing** and is a statement about a different model. That includes the headline SBC pair (φ 0.4688 / alm 0.5312, job 11903181) and every entry in `achievements.md`. They are kept as the pre-change reference to compare against, not as current results.
